import { DataSourceSystem } from '../src/DataSourceSystem';
...
describe('DataSourceSystem', () => {
  ...
  describe('createDataSource method', () => {
    it('Create dataSource instance ', () => {
      const ds = dsSystem.createDataSource({
  ...
  describe('Cache received records into session storage', () => {
    ...
    it('DataSource object should return independent iterator objects', () => {
      const ds = dsSystem.createDataSource({
        name: 'MyTestDataSourceInstance',
        type: 'Range',
        to: 10,
    ...
    it('DataSource object should cache result into storage', () => {
